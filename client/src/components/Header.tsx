    ...
    <header className="bg-transparent absolute top-0 left-0 right-0 px-4 sm:px-6 py-5 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" className="text-[#1a1a2e]">
            <path d="M12 2L15 8H9L12 2Z" fill="currentColor"/>
            <circle cx="12" cy="14" r="5" stroke="currentColor" strokeWidth="2" fill="none"/>
          </svg>
          <span className="text-base font-medium text-[#1a1a2e] tracking-tight" style={{ fontFamily: "'Inter', sans-serif" }}>
            Zenko Digital
          </span>
        </div>
