      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal text-[#1a1a2e] leading-tight mb-6" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
            <TranslatedText>What We</TranslatedText> <span className="text-[#4d8af0]"><TranslatedText>Offer</TranslatedText></span>
          </h2>
          <p className="text-[#6b7280] text-base md:text-lg max-w-2xl mx-auto" style={{ fontFamily: "'Inter', sans-serif" }}>
            <TranslatedText>We create digital experiences that not only look stunning but also drive meaningful engagement and business growth.</TranslatedText>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="group rounded-2xl md:rounded-3xl bg-white border border-gray-100 p-6 md:p-8 hover:border-[#4d8af0]/30 transition-all duration-300 hover:shadow-xl shadow-sm">
            <div className="flex justify-between items-start mb-6">
              <h3 className="text-[#1a1a2e] font-semibold text-xl md:text-2xl leading-tight group-hover:text-[#4d8af0] transition-colors" style={{ fontFamily: "'Inter', sans-serif" }}>
                <TranslatedText>Brand Building &</TranslatedText><br /><TranslatedText>Strategy</TranslatedText>
              </h3>
            ...
            <p className="text-[#6b7280] text-sm md:text-base mb-6 leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
              <TranslatedText>We develop comprehensive brand strategies that resonate with your audience and create lasting emotional connections.</TranslatedText>
            </p>
          ...
          <div className="group rounded-2xl md:rounded-3xl bg-white border border-gray-100 p-6 md:p-8 hover:border-[#4d8af0]/30 transition-all duration-300 hover:shadow-xl shadow-sm">
            <div className="flex justify-between items-start mb-6">
              <h3 className="text-[#1a1a2e] font-semibold text-xl md:text-2xl leading-tight group-hover:text-[#4d8af0] transition-colors" style={{ fontFamily: "'Inter', sans-serif" }}>
                <TranslatedText>Creative Digital</TranslatedText><br /><TranslatedText>Solutions</TranslatedText>
              </h3>
            ...
            <p className="text-[#6b7280] text-sm md:text-base mb-6 leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
              <TranslatedText>From web development to mobile apps, we craft innovative digital solutions that push boundaries and exceed expectations.</TranslatedText>
            </p>
            <div className="overflow-hidden rounded-xl md:rounded-2xl">
              <img
                src={DigitalImage}
          ...
          <div className="group rounded-2xl md:rounded-3xl bg-white border border-gray-100 p-6 md:p-8 hover:border-[#4d8af0]/30 transition-all duration-300 hover:shadow-xl shadow-sm">
            <div className="flex justify-between items-start mb-6">
              <h3 className="text-[#1a1a2e] font-semibold text-xl md:text-2xl leading-tight group-hover:text-[#4d8af0] transition-colors" style={{ fontFamily: "'Inter', sans-serif" }}>
                <TranslatedText>Marketing &</TranslatedText><br /><TranslatedText>Campaigns</TranslatedText>
              </h3>
              <span className="w-10 h-10 md:w-12 md:h-12 bg-[#4d8af0] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg shadow-blue-200/50">
                <ArrowUpRight className="w-5 h-5 md:w-6 md:h-6 text-white" />
              </span>
            ...
            <p className="text-[#6b7280] text-sm md:text-base mb-6 leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
              <TranslatedText>Strategic marketing campaigns that amplify your reach, engage your audience, and drive measurable business growth.</TranslatedText>
            </p>
            <div className="overflow-hidden rounded-xl md:rounded-2xl">
              <img
                src={MarketingImage}
