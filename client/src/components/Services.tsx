      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <p className="text-[#F25C23] text-sm tracking-widest font-bold uppercase font-sans">WHAT WE DO</p>
            </div>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#DEDEDE] leading-tight mb-8 max-w-4xl mx-auto font-display">
            ...
            <p className="text-[#DEDEDE]/70 text-lg max-w-2xl mx-auto mb-8 font-sans">
              We create digital experiences that not only look stunning but also drive meaningful engagement and business growth.
            </p>
            <button className="bg-transparent border-2 border-[#F25C23] px-8 py-4 rounded-full font-bold text-[#DEDEDE] font-sans hover:bg-[#F25C23] hover:text-[#171717] transition-all duration-300 flex items-center gap-3 mx-auto transform hover:scale-105">
          ...
          {/* Brand Building Card */}
            <div className="rounded-2xl bg-[#4D4D4D] p-8 flex flex-col shadow-xl min-h-[400px] relative hover-lift group border border-transparent hover:border-[#F25C23]/40 transition-all duration-300">
              <div className="flex justify-between items-start mb-4">
                <h3 className="uppercase text-[#DEDEDE] font-black text-2xl leading-tight font-display group-hover:text-[#F25C23] transition-colors duration-300">
              ...
              <p className="text-[#DEDEDE]/80 text-base mb-6 leading-relaxed font-sans">
            ...
            <div className="rounded-2xl bg-[#4D4D4D] p-8 flex flex-col shadow-xl min-h-[400px] relative hover-lift group border border-transparent hover:border-[#F25C23]/40 transition-all duration-300">
              ...
              <p className="text-[#DEDEDE]/90 text-base mb-6 leading-relaxed font-sans">
